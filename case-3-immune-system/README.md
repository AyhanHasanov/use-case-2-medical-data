...
Нека кажем, че това е потока на работа на информационната система - данните се събират в базата от данни (в случая данните са налице, но не са актуални). Информационната система, след това, ще използва данните от базата, за да направи обстоен анализ на броя нови заболели, смъртни и хоспитализирани случаи и дали мерките за сигурност са повлиявли положително. Ако броя на заболелите спада - могат мерките да се разпуснат или да се обтегнат в противния случай.
